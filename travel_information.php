...
<p class="warning">
  Book your accommodation ahead! See <a href="?page=accommodation">here</a>.
</p>
...
<p>
  Use train or tram to get to the city. Make sure you have a valid ticket for <b>3 zones before</b> entering the tram/train
  (press destination "Zurich HB" on the vending machine).
</p>


<h3>Getting to the Conference / Irchel campus</h3>
<p>
  Use tram number 7, 9, 10 or 14 or busses 69 or 72 to the stops "Irchel" or "Milchbuck".
  Then follow the signs though the park to the University of Zurich Irchel Campus.
  For detailed information, check the <a href="http://www.zvv.ch/zvv/en/home.html">timetable</a>.
</p>

<h3>Finding the Rooms (Y36G16 HS20)</h3>
<p>
  Take one of the main entrances and follow the signs for "Hörsaal 20"
